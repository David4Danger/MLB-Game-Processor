package com.mlb.game.processor.util;
...
// Thanks to https://github.com/pfilipowicz/aws-json-api-gateway-caller for the code for calling API Gateway
public class JsonApiGatewayCaller extends AmazonWebServiceClient {
    ...
    public ApiGatewayResponse execute(HttpMethodName method, String resourcePath, Map<String, List<String>> queryParams) {
        final ExecutionContext executionContext = createExecutionContext();

        DefaultRequest request = prepareRequest(method, resourcePath, queryParams);
    ...
    private DefaultRequest prepareRequest(HttpMethodName method, String resourcePath, Map<String, List<String>> queryParams) {
